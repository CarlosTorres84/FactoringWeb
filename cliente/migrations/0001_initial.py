# Generated by Django 4.2.7 on 2024-02-13 11:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cli_im', models.CharField(blank=True, max_length=20, null=True)),
                ('cli_ie', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('cli_telefone2', models.CharField(blank=True, max_length=15, null=True)),
                ('cli_endereco', models.CharField(max_length=50)),
                ('cli_complementoendereco', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('cli_taxacompra', models.DecimalField(decimal_places=7, max_digits=9)),
                ('cli_multa', models.DecimalField(decimal_places=7, max_digits=9)),
                ('cli_juros', models.DecimalField(decimal_places=7, max_digits=9)),
                ('cli_taxarecompra', models.DecimalField(decimal_places=7, max_digits=10)),
                ('cli_valortotaloperacao', models.DecimalField(decimal_places=7, max_digits=17)),
        ...
        migrations.CreateModel(
            name='Dcontratomae',
            fields=[
                ('cma_id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fac_im', models.CharField(blank=True, max_length=20, null=True)),
                ('fac_ie', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('fac_telefone2', models.CharField(blank=True, max_length=15, null=True)),
                ('fac_endereco', models.CharField(max_length=50)),
                ('fac_complementoendereco', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            name='Dsimulacao',
            fields=[
                ('sim_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('sim_datasimulacao', models.DateField()),
                ('sim_taxacompra', models.DecimalField(decimal_places=7, max_digits=10)),
                ...
                ('sim_despesas', models.DecimalField(decimal_places=7, max_digits=10)),
                ('sim_acrescimos', models.DecimalField(decimal_places=7, max_digits=10)),
                ('sim_float', models.IntegerField()),
                ('sim_vencimento1', models.DateField()),
                ('sim_valortotal1', models.DecimalField(decimal_places=7, max_digits=12)),
                ...
                ('sim_valortotal2', models.DecimalField(blank=True, decimal_places=7, max_digits=12, null=True)),
                ...
                ('sim_valortotal3', models.DecimalField(blank=True, decimal_places=7, max_digits=12, null=True)),
                ...
                ('sim_valortotal4', models.DecimalField(blank=True, decimal_places=7, max_digits=12, null=True)),
                ...
                ('sim_valortotal5', models.DecimalField(blank=True, decimal_places=7, max_digits=12, null=True)),
                ...
                ('sim_valortotal6', models.DecimalField(blank=True, decimal_places=7, max_digits=12, null=True)),
                ...
                ('sim_status', models.CharField(choices=[('1', 'SIMULAÇÃO'), ('3', 'CANCELADO')], max_length=1)),
                ('cli_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cliente.dcliente')),
        ...
        migrations.CreateModel(
            name='Dpessoas',
            fields=[
                ('pes_id', models.AutoField(primary_key=True, serialize=False)),
                ('pes_nome', models.CharField(max_length=50)),
                ('pes_cpf', models.CharField(max_length=14)),
                ('pes_rg', models.CharField(max_length=14)),
                ('pes_estadocivil', models.CharField(choices=[('S', 'SOLTEIRO(A)'), ('C', 'CASADO(A)'), ('D', 'DIVORCIADO(A)'), ('V', 'VIÚVO(A)')], max_length=14)),
                ...
                ('pes_telefone2', models.CharField(blank=True, max_length=15, null=True)),
                ('pes_profissao', models.CharField(max_length=30)),
                ('pes_endereco', models.CharField(max_length=50)),
                ('pes_complementoendereco', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            name='Doperacao',
            fields=[
                ('ope_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('ope_dataoperacao', models.DateField()),
                ('ope_taxacompra', models.DecimalField(decimal_places=7, max_digits=10)),
                ...
                ('ope_telefone2', models.CharField(blank=True, max_length=15, null=True)),
                ...
                ('ope_telefone3', models.CharField(blank=True, max_length=15, null=True)),
                ...
                ('ope_telefone4', models.CharField(blank=True, max_length=15, null=True)),
                ...
                ('ope_telefone5', models.CharField(blank=True, max_length=15, null=True)),
                ...
                ('ope_telefone6', models.CharField(blank=True, max_length=15, null=True)),
                ...
                ('ope_status', models.CharField(choices=[('2', 'OPERAÇÃO'), ('3', 'CANCELADO')], max_length=1)),
                ('cli_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cliente.dcliente')),
