...
class Dcliente(models.Model):
    ...
    cli_taxacompra=models.DecimalField(max_digits=9, decimal_places=2)
    cli_multa=models.DecimalField(max_digits=9, decimal_places=2)
    cli_juros=models.DecimalField(max_digits=9, decimal_places=2)
...
class Dcontratomae(models.Model):
    ...
    def __str__(self):
        return f'{self.cli_id} - {self.cma_id2} - {self.cma_validadecontrato}'
...
class Dsimulacao(models.Model):
    ...
    cli_id = models.ForeignKey(Dcliente, on_delete=models.CASCADE)
    fac_id=models.ForeignKey(Dfactoring, on_delete=models.CASCADE)        
    sim_taxacompra = models.DecimalField(max_digits=10, decimal_places=2)
    sim_iof = models.DecimalField(max_digits=10, decimal_places=2)
    sim_iofadicional = models.DecimalField(max_digits=10, decimal_places=2)
    ...
    sim_valortotal1 = models.DecimalField(max_digits=12, decimal_places=2)
    ...
    sim_valortotal2 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    ...
    sim_valortotal3 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    ...
    sim_valortotal4 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    ...
    sim_valortotal5 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    ...
    sim_valortotal6 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
...
class Doperacao(models.Model):    
    ope_id = models.AutoField(primary_key=True, editable=False)
    ope_dataoperacao = models.DateField()
    cma_id=models.ForeignKey(Dcontratomae, on_delete=models.CASCADE)    
    cli_id = models.ForeignKey(Dcliente, on_delete=models.CASCADE)
    fac_id=models.ForeignKey(Dfactoring, on_delete=models.CASCADE)    
    ope_taxacompra = models.DecimalField(max_digits=10, decimal_places=2)
    ope_iof = models.DecimalField(max_digits=10, decimal_places=2)
    ...
    ope_valortotal1 = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    ...
    ope_valortotal2 = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, default=0)
    ...
    ope_valortotal3 = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, default=0)
    ...
    ope_valortotal4 = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, default=0)
    ...
    ope_valortotal5 = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, default=0)
    ...
    ope_valortotal6 = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, default=0.00)
    ...
    def __str__(self):
        return f'{self.ope_id} - {self.cli_id}'
