...
class Dcliente(models.Model):
    ...
    cli_taxacompra=models.DecimalField(max_digits=9, decimal_places=7)
    cli_multa=models.DecimalField(max_digits=9, decimal_places=7)
    cli_juros=models.DecimalField(max_digits=9, decimal_places=7)
    cli_taxarecompra=models.DecimalField(max_digits=10, decimal_places=7)
    cli_valortotaloperacao=models.DecimalField(max_digits=17, decimal_places=7)
...
class Dsimulacao(models.Model):
    ...
    cli_id = models.ForeignKey(Dcliente, on_delete=models.CASCADE)
    fac_id=models.ForeignKey(Dfactoring, on_delete=models.CASCADE)        
    sim_taxacompra = models.DecimalField(max_digits=10, decimal_places=7)
    ...
    sim_despesas = models.DecimalField(max_digits=10, decimal_places=7)
    sim_acrescimos = models.DecimalField(max_digits=10, decimal_places=7)
    sim_float = models.IntegerField()
    sim_vencimento1 = models.DateField()
    sim_valortotal1 = models.DecimalField(max_digits=12, decimal_places=7)
    ...
    sim_valortotal2 = models.DecimalField(max_digits=12, decimal_places=7, null=True, blank=True)
    ...
    sim_valortotal3 = models.DecimalField(max_digits=12, decimal_places=7, null=True, blank=True)
    ...
    sim_valortotal4 = models.DecimalField(max_digits=12, decimal_places=7, null=True, blank=True)
    ...
    sim_valortotal5 = models.DecimalField(max_digits=12, decimal_places=7, null=True, blank=True)
    ...
    sim_valortotal6 = models.DecimalField(max_digits=12, decimal_places=7, null=True, blank=True)
...
class Doperacao(models.Model):    
    ...
    cli_id = models.ForeignKey(Dcliente, on_delete=models.CASCADE)
    fac_id=models.ForeignKey(Dfactoring, on_delete=models.CASCADE)    
    ope_taxacompra = models.DecimalField(max_digits=10, decimal_places=7)
